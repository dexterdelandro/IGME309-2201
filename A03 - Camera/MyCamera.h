/*----------------------------------------------
Programmer: Dexter Delandro (dmd7488@rit.edu)
Date: 2020
----------------------------------------------*/
...
namespace Simplex
{
	...
	public:
		...
		*/
		...
		/*
		USAGE: Rotates the camera by it's pitch (the yz plane)
		ARGUMENTS: float a_fAngle-> amount of degrees you are rotating by
		OUTPUT: ---
		*/
		void UpdatePitch(float a_fAngle);

		/*
		USAGE: Rotates the camera by it's yaw (the xz plane)
		ARGUMENTS: float a_fAngle-> amount of degrees you are rotating by
		OUTPUT: ---
		*/
		void UpdateYaw(float a_fAngle);
